...
class ChampionshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post championships_url, params: { championship: { champteam_id: @championship.champteam_id, local: @championship.local, nome: @championship.nome, premiacao: @championship.premiacao } }
    end
  ...
  test "should update championship" do
    patch championship_url(@championship), params: { championship: { champteam_id: @championship.champteam_id, local: @championship.local, nome: @championship.nome, premiacao: @championship.premiacao } }
